  ...
  module ByPassword
    ...
    def self.included(recipient)
      ...
      recipient.class_eval do
        ...
        validates_presence_of     :password,                   :if => :password_required?, :message => 'deve ser preenchida'
        validates_presence_of     :password_confirmation,      :if => :password_required?, :message => 'deve ser preenchida'
        validates_confirmation_of :password,                   :if => :password_required?, :message => 'está diferente da confirmação'
        validates_length_of       :password, :within => 6..40, :if => :password_required?, :message => 'deve possuir ao menos 6 caracteres'
